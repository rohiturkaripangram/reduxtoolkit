...
export default function Checkout() {
  ...
  return (
    <>
      {
        cartItems.length > 0 ? <div className="mx-auto my-4 max-w-4xl md:my-6">
          <div className="overflow-hidden  rounded-xl shadow">
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="bg-gray-100 px-5 py-6 md:px-8">
                ...
                {
                    CoupenValues.map(element=><p className="mt-4 text-sm text-gray-500 font-medium  text-left transform-uppercase">use<span className='text-96C291 font-large'> {element.coupenName}</span> for Rs {element.value} off</p>)
                }
                ...
                <ul className="mt-6 space-y-3">
                  <li className="flex items-center justify-between text-gray-600">
                    ...
                    <p className="text-sm font-medium">{cartItems.reduce((p1, p2) => p1 + p2.price, 0)}</p>
                  </li>
                  ...
                  <li className="flex items-center justify-between text-gray-900">
                    ...
                    <p className="text-sm font-bold ">{cartItems.reduce((p1, p2) => p1 + p2.price, 0) - coupenData}</p>
                  </li>
                </ul>
              </div>
