        ...
        <div className="mx-auto max-w-5xl">
          <div className="flex flex-wrap items-center">
              ...
              <div className="mx-auto max-w-sm rounded-md border border-gray-200 bg-white pb-20 pl-5 pr-8 pt-6 lg:pb-8">
                ...
                <div className="mt-7 border-t border-gray-100 pt-5">
                  <ul className="mb-10">
                    ...
                    <li className="mb-6 flex items-center">
                      <span className="ml-2 text-sm text-gray-900">Ecommerce support</span>
                    </li>
                    <li className="mb-6 flex items-center">
                      <span className="ml-2 text-sm text-gray-900">Design Style</span>
                    </li>
                    <li className="mb-6 flex items-center">
                      <span className="ml-2 text-sm text-gray-900">Call services</span>
                    </li>
                    <li className="mb-6 flex items-center">
                  ...
                  <button
                    type="button"
                    className="rounded-md border border-black px-3 py-2 text-sm font-semibold text-black shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black bg-adtc"
                  >
                    Choose Plan
                  </button>
                </div>
            ...
            <div className="-mt-4 w-full lg:-mt-0 lg:w-1/3">
              <div className="pt-22 relative mx-auto max-w-sm rounded-lg bg-bgcolor px-10 pb-16 ">
                <div className="absolute left-1/2 top-0 inline-flex -translate-x-1/2 -translate-y-1/2 transform items-center justify-center rounded-full bg-white p-2">
                  <div className="flex-shrink-0 rounded-full bg-bgcolor px-5 py-4 text-sm font-semibold uppercase text-white">
                    Most Popular
                  </div>
                </div>
                ...
                <div className="mt-7 border-t border-orange-500 pt-5">
                  <ul className="mb-10">
                    ...
                    <li className="mb-6 flex items-center">
                      <span className="ml-2 text-sm text-white">Ecommerce Support</span>
                    </li>
                    <li className="mb-6 flex items-center">
                      <span className="ml-2 text-sm text-white">Design Style</span>
                    </li>
                    <li className="mb-6 flex items-center">
                      <span className="ml-2 text-sm text-white">Call support</span>
                    </li>
                    <li className="mb-6 flex items-center">
                      <span className="ml-2 text-sm text-white">Unlimited users</span>
                    </li>
                    <li className="mb-6 flex items-center">
                      <span className="ml-2 text-sm text-white">User Services</span>
                  ...
                  <button
                    type="button"
                    className="rounded-md  px-3 py-2 text-sm font-semibold text-black shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white bg-adtc"
                  >
                    Choose Plan
                  </button>
                </div>
              ...
              <div className="rounded-b-5xl lg:rounded-r-5xl mx-auto max-w-sm border border-gray-200 bg-white pb-8 pl-8 pr-5 pt-12 lg:rounded-b-none lg:pt-6">
                ...
                <div className="mt-7 border-t border-gray-100 pt-5">
                  <ul className="mb-10">
                    ...
                    <li className="mb-6 flex items-center">
                      <span className="ml-2 text-sm text-gray-900">Call support </span>
                    </li>
                    <li className="mb-6 flex items-center">
                      <span className="ml-2 text-sm text-gray-900">User access</span>
                    </li>
                    <li className="mb-6 flex items-center">
                      <span className="ml-2 text-sm text-gray-900">Unlimited user</span>
                    </li>
                    <li className="mb-6 flex items-center">
